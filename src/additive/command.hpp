#ifndef TIMESMAP_ADDITIVE_COMMAND_H_
#define TIMESMAP_ADDITIVE_COMMAND_H_
 ...
 *  additive model. Other models might adapt that as needed, using different hyper params.
 */
struct AdditiveCLI
{
    DataFiles files;
    Runparams run;
    AdditiveHyperparams hyper;
};

/**
 * @brief Add the "additive" model command to a given app.
 */
