...
if args.mode == 1:
	...
	alpha_trace.to_csv(args.output+"_additive_alpha_trace.txt",sep="\t",header=False,index=False)
	beta_trace.to_csv(args.output+"_additive_beta_trace.txt",sep="\t",header=False,index=False)
	gamma_trace.to_csv(args.output+"_additive_gamma_trace.txt",sep="\t",header=False,index=False)
